...
public class MainMasterVisitors extends BaseClass {
    ...
    public Object[][] dataProviderMethod() {
        ...
        Object[][] data = excelDataProvider.readFromExcel(conFileReader.getFileNameMainMasterVisitors());
    ...
    // This test case is to add visitors in MainMaster
    ...
    public  void addRoles(String sno,String visitors) throws InterruptedException {
        PageFactory.initElements(driver, MainMaster.class);
        MainMaster mainMaster=new MainMaster(driver);

        mainMaster.getAddVisitors().click();
        ...
        mainMaster.getEnterVisitors().sendKeys(visitors);
        mainMaster.getClickSubmit().click();
